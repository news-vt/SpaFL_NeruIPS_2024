...
def parser():
    ...
    parser.add_argument('--model', choices=['resnet18'], default='resnet18', #This adds an argument to the parser
    ...
    parser.add_argument('--dist', choices=['path', 'dir'], default='dir')
    ...
    parser.add_argument('--lr_decay', type = float, default = 0.991, help= "lr_decay per comm round")
    ...
    parser.add_argument('--th_coeff', type=float, default = 1e-6, help = "regularizer for thresholds")
